            ...
            <div className="heading-events-body">
                    <div className="row">
                        ...
                        <div className="col-xxl-6 col-xl-6 col-lg-6 col-12 add-event-btn">
                            ...
                            <button className="btn btn-primary add-events" onClick={handleShowModal}>
                                + Add Events
                            </button>
                 ...
                 {/* Render the Modal and pass the state and handlers */}
                    <EventType showModal={showModal} handleCloseModal={handleCloseModal} />  
